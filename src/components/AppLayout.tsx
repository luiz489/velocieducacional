...
export function AppLayout() {
  ...
  const escolaNome = escolas.find((e) => e.escola_id === escolaAtivaId)?.nome;
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {emModoAdministrador && (
            <div className="h-9 shrink-0 bg-amber-500 text-amber-950 flex items-center justify-center gap-2 px-4 text-xs font-medium">
              ...
              <span>
                Você está conectado como administrador no ambiente de <strong>{escolaNome}</strong> — não é sua escola de origem.
              </span>
