 ...
 * licença de uso, implantação parcelada (em tabela), mensalidade (em tabela),
 * fidelidade (prazo variável), SLA detalhado com níveis de severidade,
 * disponibilidade garantida, backup/continuidade de negócio, segurança da
 * informação, atualizações/versionamento, propriedade intelectual,
 * limitação de responsabilidade, LGPD, confidencialidade, não aliciamento
 * de equipe, vigência/rescisão e foro.
 */
export function gerarContratoSaas(dados: DadosContratoSaas, plataforma: DadosPlataforma): string {
  ...
  const temFidelidade = dados.meses_fidelidade > 0;
...
termos do Acordo de Nível de Serviço (SLA) estabelecido na Cláusula 7ª.</p>
...
a CONTRATANTE pagará à CONTRATADA os valores abaixo:</p>
<table style="width:100%; border-collapse:collapse; margin:8px 0;">
  <tr><td colspan="2" style="background:#e8e8e8; padding:4px; border:1px solid #999; text-align:center;"><strong>Valor de Implantação</strong></td></tr>
  <tr><td style="border:1px solid #999; padding:4px; width:45%;"><strong>Valor Total</strong></td><td style="border:1px solid #999; padding:4px;">R$ ${fmtMoeda(dados.valor_implantacao)}</td></tr>
  <tr><td style="border:1px solid #999; padding:4px;"><strong>Forma de Pagamento</strong></td><td style="border:1px solid #999; padding:4px;">${
    dados.parcelas_implantacao > 1
      ? `${dados.parcelas_implantacao}x de R$ ${fmtMoeda(parcelaImplantacao)}, mensais e consecutivas`
      : `Parcela única`
  }</td></tr>
</table>
...
<p>Pela licença de uso e prestação contínua dos serviços SaaS, a CONTRATANTE pagará à CONTRATADA os valores
abaixo:</p>
<table style="width:100%; border-collapse:collapse; margin:8px 0;">
  <tr><td colspan="2" style="background:#e8e8e8; padding:4px; border:1px solid #999; text-align:center;"><strong>Mensalidade</strong></td></tr>
  <tr><td style="border:1px solid #999; padding:4px; width:45%;"><strong>Valor Mensal</strong></td><td style="border:1px solid #999; padding:4px;">R$ ${fmtMoeda(dados.valor_mensal)}</td></tr>
  <tr><td style="border:1px solid #999; padding:4px;"><strong>Vencimento</strong></td><td style="border:1px solid #999; padding:4px;">Todo dia ${dados.dia_vencimento} de cada mês</td></tr>
  <tr><td style="border:1px solid #999; padding:4px;"><strong>Início da Cobrança</strong></td><td style="border:1px solid #999; padding:4px;">${fmtData(dados.data_inicio)}</td></tr>
</table>
...
${temFidelidade ? `
<p><strong>CLÁUSULA 5ª — DA FIDELIDADE</strong></p>
<p>O presente contrato terá um prazo mínimo de permanência (fidelidade) de <strong>${dados.meses_fidelidade} (${dados.meses_fidelidade === 1 ? "um" : dados.meses_fidelidade} ${dados.meses_fidelidade === 1 ? "mês" : "meses"})</strong>,
contados a partir da data de início da prestação dos serviços indicada na Cláusula 3ª, prazo necessário para
amortização dos investimentos e custos de implantação, treinamento e disponibilização da plataforma.</p>
<p><strong>Parágrafo Único.</strong> Caso a CONTRATANTE solicite o cancelamento do contrato antes do término do
prazo de fidelidade estabelecido nesta cláusula, ficará sujeita ao pagamento de multa rescisória correspondente
ao valor das mensalidades remanescentes até o término do período de fidelidade, sem prejuízo dos valores já
devidos até a data do cancelamento.</p>
` : ""}

<p><strong>CLÁUSULA ${temFidelidade ? "6ª" : "5ª"} — DA IMPLANTAÇÃO E ONBOARDING</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "7ª" : "6ª"} — DO ACORDO DE NÍVEL DE SERVIÇO (SLA)</strong></p>
<p><strong>${temFidelidade ? "7" : "6"}.1. Disponibilidade.</strong> A CONTRATADA garante disponibilidade mensal da plataforma de
...
<p><strong>${temFidelidade ? "7" : "6"}.2. Créditos por descumprimento.</strong> Caso a disponibilidade mensal efetiva fique abaixo do garantido no
item ${temFidelidade ? "7" : "6"}.1, a CONTRATANTE fará jus a créditos na mensalidade seguinte, conforme a tabela abaixo:</p>
<table style="width:100%; border-collapse:collapse; margin:8px 0;">
  <tr>
...
<p><strong>${temFidelidade ? "7" : "6"}.3. Níveis de severidade de chamados.</strong> Os chamados de suporte técnico abertos pela CONTRATANTE
...
<p><strong>${temFidelidade ? "7" : "6"}.4. Horário de atendimento.</strong> O suporte técnico é prestado em horário comercial (dias úteis, das 8h às
...
<p><strong>${temFidelidade ? "7" : "6"}.5. Exclusões do SLA.</strong> Não estão cobertos pelo SLA: lentidão ou indisponibilidade decorrente da
...
<p><strong>CLÁUSULA ${temFidelidade ? "8ª" : "7ª"} — DE BACKUP E CONTINUIDADE DE NEGÓCIO</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "9ª" : "8ª"} — DA SEGURANÇA DA INFORMAÇÃO</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "10ª" : "9ª"} — DAS ATUALIZAÇÕES E EVOLUÇÃO DA PLATAFORMA</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "11ª" : "10ª"} — DA PROPRIEDADE INTELECTUAL</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "12ª" : "11ª"} — DA LIMITAÇÃO DE RESPONSABILIDADE</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "13ª" : "12ª"} — DA PROTEÇÃO DE DADOS (LGPD)</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "14ª" : "13ª"} — DA CONFIDENCIALIDADE</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "15ª" : "14ª"} — DO NÃO ALICIAMENTO DE COLABORADORES</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "16ª" : "15ª"} — DA VIGÊNCIA E RESCISÃO</strong></p>
<p>O presente contrato vigorará por prazo indeterminado a partir da data de sua assinatura${temFidelidade ? ", respeitado o prazo mínimo de fidelidade estabelecido na Cláusula 5ª," : ""}
podendo ser rescindido por qualquer das partes, mediante aviso prévio por escrito com antecedência mínima de 30 (trinta) dias.</p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "17ª" : "16ª"} — DAS DISPOSIÇÕES GERAIS</strong></p>
...
<p><strong>CLÁUSULA ${temFidelidade ? "18ª" : "17ª"} — DO FORO</strong></p>
