  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">Gerencie disciplinas e as matrizes curriculares por série.</p>
      </div>
      <Tabs defaultValue="matrizes" className="w-full">
        <TabsList>
          <TabsTrigger value="matrizes"><GraduationCap className="h-4 w-4 mr-2" />Matrizes</TabsTrigger>
          <TabsTrigger value="disciplinas"><BookOpen className="h-4 w-4 mr-2" />Disciplinas</TabsTrigger>
        </TabsList>
        <TabsContent value="matrizes" className="mt-4">
          <MatrizesTab />
        </TabsContent>
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>Cadastro de disciplinas que compõem as matrizes.</CardDescription>
        </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Defina o conjunto de disciplinas por série e ano letivo.</CardDescription>
          </div>
          <Dialog open={open} onOpenChange={(v) => { setOpen(v); if (!v) reset(); }}>
            <DialogTrigger asChild>
